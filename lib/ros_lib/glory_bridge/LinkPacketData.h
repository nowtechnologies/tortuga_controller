#ifndef _ROS_glory_bridge_LinkPacketData_h
#define _ROS_glory_bridge_LinkPacketData_h
...
namespace glory_bridge
{
  ...
  class LinkPacketData : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "glory_bridge/LinkPacketData"; };
