...
namespace costmap_cspace_msgs
{
  ...
  class CSpace3DUpdate : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "costmap_cspace_msgs/CSpace3DUpdate"; };
    virtual const char * getMD5() override { return "96652e1e1204436fdc0c25c35382eb42"; };
