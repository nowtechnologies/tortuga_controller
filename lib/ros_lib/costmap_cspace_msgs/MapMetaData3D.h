...
namespace costmap_cspace_msgs
{
  ...
  class MapMetaData3D : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "costmap_cspace_msgs/MapMetaData3D"; };
    virtual const char * getMD5() override { return "64571c9ed0c92d4e4b7d5cd2a97576a7"; };
